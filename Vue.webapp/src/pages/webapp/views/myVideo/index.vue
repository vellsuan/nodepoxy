    ...
    <div class="video-man">
      ...
      <div class="video-manitem">
        <div class="video-manitem-fontsie">
          <p class="video-manitem-p"><span><span id="video-manitem-name" v-text="workerName">王芳红</span><span
            class="video-manitem-Occupation" v-text="workerTitle">国家职业医药师</span></span>
          </p>
